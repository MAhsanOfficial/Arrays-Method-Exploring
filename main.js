...
let names = ["Ali", "Danish", "arsaln", "Uzair", "Khan"];
...
console.log(popArr);
let popArr2 = [23, 45, 667, 879, 98];
popArr.pop();
console.log(popArr2); // delte last element of array  "98"
//     2) Push                 // The Element add on last element
...
let arr4 = [1213, false, "ahsan", 4546];
arr4.valueOf();
...
let sortArr = [4545, 6734, 343.123, 56, 932, 22];
sortArr.sort();
